                                            ...
                                            <ul id="menu-1-27a11a7f" class="elementor-nav-menu">
                                                ...
                                                <li
                                                    ...
                                                    <a href="<?php echo $baseUrl ?>/about/"
                                                        class="elementor-item elementor-item-active">আমাদের সম্পর্কে</a>
                                                </li>
                                                <li
                        ...
                        <div class="e-con-inner">
                            ...
                            <div class="elementor-element elementor-element-2bcf5620 e-con-full e-flex e-con e-child"
                                ...
                                <div class="elementor-widget-container">
                                    ...
                                    <h5>আমরা এই ওয়েবসাইটটি তৈরি করেছি যাতে ব্যবহারকারীরা কোনো পণ্য কেনার আগে সংশ্লিষ্ট পেজ সম্পর্কে যাচাই-বাছাই করতে পারে। আবার, যদি কেউ প্রতারিত হয়ে থাকে, আমরা বিভিন্ন গ্রুপে বা পোস্টে তা শেয়ার করি। তবে আগের পোস্টগুলো পুরান/ঢেকে গেলে আমরা পরবর্তীতে তা জানতে পারি না। এই সমস্যা সমাধানের জন্য এই ওয়েবসাইটটি তৈরি করা হয়েছে। এখানে সব পেজের ডেটা থাকবে এবং আপনার রিপোর্টের মাধ্যমে অন্যরাও প্রতারণার হাত থেকে বাঁচতে পারবে।</h5>
                                </div>
